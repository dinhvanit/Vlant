      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            type="email"
            required
            className="w-full h-11 px-4 bg-input-background border border-border/50 rounded-xl"
          />
        </div>
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full h-11 px-4 pr-12 bg-input-background border border-border/50 rounded-xl"
            />
            <button
              type="button"
